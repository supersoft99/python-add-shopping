...
class CartScreen(Screen):
    ...
    def fillCart(self, event, store):
        #TODO have to agree Dictionary object? store?
...
class DetailScreen(Screen):
    #if click "Add to cart" button on product detail page -> bttn_clicks = 1 -> push item into the store (shopping cart), Quantity = 1
    def fillCart (self):
        self.bttn_clicks = 0
        self.update_quantity()

    #if click "Add to cart" button on product details page again -> bttn_clicks += 1 -> Quantity +1
